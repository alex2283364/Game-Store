...
Перейдите на страницу Регистрация (/register)
Заполните данные:
...
Выйдите из аккаунта (кнопка Выйти в хедере)
Снова перейдите на Регистрацию
Заполните данные:
...
Нажмите Зарегистрироваться
🔹 Шаг 3: Начните чат
Убедитесь, что вы вошли как player2
Перейдите в раздел Чат (/chat)
Нажмите кнопку ✏️ Новый чат
В поле поиска введите player1
Кликните на найденного пользователя в результатах поиска
🔹 Шаг 4: Проверьте обмен сообщениями
Действие
Ожидаемый результат
Отправить сообщение от player2
Сообщение появляется в чате сразу
Переключиться на player1 (в другом браузере/инкогнито)
Новое сообщение появляется автоматически
Ответить от player1
Сообщение доставляется player2 в реальном времени
Обновить страницу
