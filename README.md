...
1. Убедитесь, что вы вошли как `player2`
2. Перейдите в раздел **Чат** (`/chat`)
3. Нажмите кнопку **✏️ Новый чат**
4. В поле поиска введите `player1`
...
|----------|-------------------|
| Отправить сообщение от `player2` | Сообщение появляется в чате сразу |
| Переключиться на `player1` (в другом браузере/инкогнито) | Новое сообщение появляется автоматически |
| Ответить от `player1` | Сообщение доставляется `player2` в реальном времени |
